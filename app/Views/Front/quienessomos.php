...
<head>
    ...
    <title>Quiénes Somos - DK Fast Food</title>
...
<body>
    ...
    <div class="container-fluid">
        <img src="assets/img/QS.png" alt="Imagen de Portada" class="imagen-portada">
    </div>
    ...
    <div class="album py-5 ">
        <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                <div class="tarjeta-quienes">
                    <div class="card shadow-sm">
                        <img class="sq-im" src="assets/img/GG.webp" alt="25">
                        <div class="card-body">
                            <p class="text-capitalize text-center">MARCOS DOMINGUEZ.</p>
                            <p class="text-center fw-normal">Gerente General</p>
                        </div>
                    </div>
                </div>
                <div class="tarjeta-quienes">
                    <div class="card shadow-sm">
                        <img class="sq-im" src="assets/img/CE.jpg" alt="25">
                        <div class="card-body">
                            <p class="text-capitalize text-center">FELIPE GUTIERREZ.</p>
                            <p class="fw-normal text-center"> Jefe de Cocina .</p>
                        </div>
                    </div>
                </div>
                <div class="tarjeta-quienes">
                    <div class="card shadow-sm">
                        <img class="sq-im" src="assets/img/GP.webp" alt="25">
                        <div class="card-body">
                            <p class="text-capitalize text-center">VICTORIA MARROCO.</p>
                            <p class="fw-normal text-center">Gerente de Personal</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container my-5 animate__animated animate__flipInX">
        <div class="row align-items-center p-4 rounded shadow"> <div class="col-12 col-md-6 text-center mb-4 mb-md-0">
                <img src="assets/img/Ubicacion.png" class="img-fluid" alt="Ubicación">
            </div>
            <div class="col-12 col-md-6 text-md-start text-center">
                <p class="display-5 fw-semibold">UBICACIÓN</p>
                <p class="fw-normal">Dirección: Lavalle 944, Corrientes Capital</p>
                <p class="fw-normal">Teléfono: +011 3765-048153</p>
